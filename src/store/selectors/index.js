export const selectorMovieLoader = state => state.loaded;
export const selectorMovies = state => state.movies;
export const selectorTotalResults = state => state.totalResults;
export const selectorCurrentPage = state => state.currentPage;
